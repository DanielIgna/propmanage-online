...
DEFAULT_CONTENT: dict[str, Any] = {
    ...
    "seo_article": [
        ...
        {"h2": "Audit Digital Twin — serviciu PropManage", "body": "Auditul Digital Twin este serviciul oficial PropManage pentru digitalizarea completă a locuinței, cu preț de pornire de 2.450 lei/unitate locativă. Include măsurători, planuri, materiale, finisaje și documentația tehnică necesară pentru construirea copiei digitale a proprietății. Este singurul serviciu, alături de Concept Design Rezidențial, care are în prezent un tarif oficial afișat pe PropManage."},
