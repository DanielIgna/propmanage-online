...
DEFAULT_CONTENT: dict[str, Any] = {
    ...
    "audit_full": {
        "title": "Auditul tehnic — diagnostic instrumental al locuinței",
        "intro": "Auditul PropManage nu este o inspecție vizuală. Este un proces de diagnostic tehnic bazat pe măsurători instrumentale, echipamente profesionale, colectare și validare de date, interpretarea rezultatelor și elaborarea de rapoarte tehnice cu recomandări fundamentate pe date reale.",
        "methodology_note": "Metodologie modulară — nu toate investigațiile de mai jos sunt necesare pentru fiecare locuință. În urma evaluării inițiale, echipa PropManage stabilește ce măsurători, analize și livrabile sunt relevante pentru tipul proprietății, scopul proiectului și obiectivele beneficiarului. Lista reprezintă capabilitățile platformei — nu un șablon aplicat identic tuturor clienților.",
        "outro": "Fiecare concluzie din raport este susținută de măsurători și de date colectate în teren, nu doar de observații vizuale. Rezultatele auditului furnizează baza tehnică pentru proiectare, Digital Twin și deciziile de investiție.",
        "key_message": "Nu livrăm doar un raport. Livrăm date măsurate, interpretate și transformate în decizii tehnice.",
        "groups": [
            {"name": "Microclimat & aer interior (măsurători instrumentale)", "items": [
                "Măsurare higrometrică a umidității (pereți, pardoseli, tavane)",
                "Calcul punct de rouă și cartografierea zonelor de risc condens",
                "Termografie completă cu cameră IR — identificarea punților termice",
                "Măsurare CO₂ și compuși organici volatili (VOC) cu senzori dedicați",
                "Diagnosticul ventilației și cuantificarea schimbului de aer",
                "Analiza calității aerului interior pe indicatori măsurabili",
                "Moisture mapping — cartografiere instrumentală a umidității"]},
            {"name": "Instalații & siguranță (investigații tehnice)", "items": [
                "Diagnosticul siguranței electrice (tablou, împământare, circuite)",
                "Măsurători electrice instrumentale (tensiune, rezistență izolație, continuitate)",
                "Analiza instalației de apă — trasee, presiune, pierderi",
                "Investigarea instalației de gaz — etanșeitate, conformitate",
                "Diagnosticul canalizării și al scurgerilor",
                "Analiza performanței sistemului de încălzire"]},
            {"name": "Structură & anvelopă (evaluare tehnică)", "items": [
                "Evaluarea structurii — fisuri, tasări, elemente portante",
                "Analiza anvelopei — izolație, tâmplărie, acoperiș",
                "Cuantificarea pierderilor de căldură și a eficienței energetice",
                "Studiu de posibilități pentru recompartimentare"]},
            {"name": "Interpretare & livrabile tehnice", "items": [
                "Corelarea datelor din toate specialitățile",
                "Analiza riscurilor tehnice pe baza măsurătorilor",
                "Priorități de intervenție (urgent / recomandat / opțional)",
                "Prioritizarea investiției pe fundament de date",
                "Estimare costuri fundamentată pe diagnoză",
                "Raport tehnic complet (PDF) cu concluzii documentate",
                "Recomandări personalizate, susținute de date",
                "Documentație foto și metodologia măsurătorilor (transparență totală)"]},
        ],
    },
    "twin_full": {
        "title": "Digital Twin — copia digitală tehnică a proprietății",
        "intro": "Digital Twin nu este un model 3D frumos și nu este un pachet fix. Este o metodologie modulară de digitalizare — configurată în funcție de tipul proprietății, obiectivele beneficiarului și nivelul de detaliu necesar pentru proiect.",
        "methodology_note": "Fiecare Digital Twin se construiește la comandă. Nu toate componentele de mai jos sunt necesare pentru orice proprietate. Echipa PropManage stabilește ce module de scanare, modelare și documentație sunt relevante pentru proiectul tău — lista de mai jos reprezintă capabilitățile platformei, nu un pachet obligatoriu.",
        "outro": "Când peste 3 ani schimbi bucătăria, designerul deschide Twin-ul și accesează exact datele relevante pentru proiect. Fără măsurători repetate. Fără informații pierdute. Fără șablon uniform.",
        "groups": [
            {"name": "Scanare 3D & geometrie", "items": [
                "Scanare 3D a proprietății",
                "Releveu complet cu măsurători exacte",
                "Model 3D interactiv al locuinței",
                "Planuri de arhitectură",
                "Planșe tehnice de execuție"]},
            {"name": "Cartografierea instalațiilor", "items": [
                "Trasee electrice ascunse (circuite, doze, tablou)",
                "Trasee apă rece și apă caldă",
                "Sistem de încălzire (calorifere, centrală, pardoseală)",
                "Canalizare și scurgeri",
                "Cartografiere electrică completă"]},
            {"name": "Model BIM & documentație tehnică", "items": [
                "Model BIM integrat (arhitectură + structură + instalații)",
                "Istoricul construcției proprietății",
                "Materiale folosite (pe fiecare zonă)",
                "Finisaje și echipamente",
                "Istoricul intervențiilor și mentenanței"]},
            {"name": "Arhivă tehnică & viață lungă", "items": [
                "Documente și contracte",
                "Garanții (cu termene monitorizate)",
                "Fotografii pe etape",
                "Actualizarea informațiilor pe parcursul ciclului de viață",
                "Property Memory — memoria completă a proprietății"]},
        ],
    },
    "positioning": {
    ...
    "digital_twin": {
        "title": "Digital Twin — soluție modulară, nu pachet fix",
        "intro": "Digital Twin este metodologia PropManage de digitalizare tehnică a proprietății. Nu este un pachet uniform — fiecare Twin se configurează în funcție de tipul imobilului, obiectivele beneficiarului și nivelul de detaliu necesar pentru proiect.",
        "contains": ["Scanare și modelare 3D", "Planșe tehnice de execuție", "Cartografierea instalațiilor",
                     "Model BIM integrat", "Istoricul proprietății", "Documente și garanții",
                     "Fotografii și arhivă tehnică", "Actualizarea informațiilor pe ciclul de viață al proprietății"],
        "modular_note": "Componentele de mai sus reprezintă capabilitățile platformei — echipa PropManage stabilește ce module sunt relevante pentru proiectul tău. Digital Twin este serviciu separat de Audit, cu ofertă personalizată.",
        "outro": "Când peste 3 ani schimbi bucătăria, designerul deschide Digital Twin-ul și accesează exact datele relevante pentru proiect. Aceasta este diferența dintre un serviciu și un ecosistem.",
        "href": "/#twin",
    },
    "audit": {
        "title": "Auditul locuinței — diagnostic tehnic, nu inspecție vizuală",
        "intro": "Auditul PropManage este un proces de diagnostic tehnic bazat pe măsurători instrumentale, echipamente profesionale și interpretarea datelor de către specialiști. Rezultatele sunt fundamentate pe date reale colectate în teren, nu pe observații vizuale.",
        "key_message": "Nu livrăm doar un raport. Livrăm date măsurate, interpretate și transformate în decizii tehnice.",
        "points": ["Măsurători instrumentale ale locuinței",
                   "Investigații termografice cu cameră IR",
                   "Analiza umidității și a microclimatului",
                   "Diagnosticul instalațiilor electrice, sanitare, HVAC",
                   "Evaluarea structurii și a anvelopei",
                   "Interpretarea și corelarea datelor tehnice",
                   "Elaborarea raportului tehnic",
                   "Recomandări fundamentate pe date reale"],
        "modular_note": "Auditul este modular — nu toate investigațiile de mai sus sunt necesare pentru fiecare locuință. Echipa PropManage stabilește ce măsurători și analize sunt relevante pentru tipul proprietății și scopul proiectului tău.",
