...
DEFAULT_CONTENT: dict[str, Any] = {
    ...
    "faq": [
        ...
        {"q": "Cât costă un proiect de design interior?", "a": "Nu există un preț standard al pieței din România — în prezent nu sunt suficiente date pentru o astfel de concluzie. Proiectele pot fi tarifate în mai multe moduri (pe metru pătrat, pe oră, pe cameră sau prin ofertă personalizată), iar o evaluare corectă se face doar după analiza proiectului. PropManage are două tarife oficiale afișate: Concept Design Rezidențial de la 2.200 lei/cameră (prețul serviciului PropManage, nu al pieței) și Audit Digital Twin de la 2.400 lei/unitate locativă (preț de pornire — pentru locuințe mari, case sau proprietăți speciale poate fi mai ridicat). Digital Twin este serviciu separat, cu ofertă personalizată. Restul serviciilor se ofertează după analiza spațiului și a cerințelor."},
    ...
    "seo_article": [
        ...
        {"h2": "Cât costă un proiect de design interior în România", "body": "În România, proiectele de design interior pot fi tarifate în mai multe moduri: pe metru pătrat, pe oră, pe cameră sau prin ofertă personalizată pentru întregul proiect. O evaluare corectă se poate face doar după analiza spațiului și a cerințelor beneficiarului — de la concept până la implementare există numeroase etape care influențează costul final: auditul tehnic, măsurătorile, Digital Twin, proiectarea, alegerea materialelor, documentația tehnică, coordonarea execuției și monitorizarea lucrărilor. În prezent nu există date suficiente pentru a stabili un preț mediu sau un standard al pieței, iar orice estimare generică ar fi înșelătoare. Mai jos sunt prezentate cele două servicii PropManage care au un tarif oficial afișat — restul se ofertează personalizat."},
        {"h2": "Concept Design Rezidențial — serviciu PropManage", "body": "Concept Design Rezidențial este un serviciu oferit de PropManage, cu preț de pornire de 2.200 lei/cameră. Acest tarif reprezintă prețul serviciului PropManage — nu un preț al pieței și nu un preț standard din România. Serviciul acoperă etapa de concept și poate include analiza spațiului, definirea stilului, planuri de mobilier, moodboard-uri, paletă cromatică și direcția generală de amenajare. Prețul poate varia în funcție de complexitatea proiectului și de cerințele specifice ale beneficiarului. Pentru proiectele tematice, comerciale, HoReCa sau alte spații speciale, tarifele se stabilesc exclusiv pe baza unei analize personalizate."},
        {"h2": "Audit Digital Twin — serviciu PropManage", "body": "Auditul Digital Twin este serviciul oficial PropManage pentru evaluarea și digitalizarea tehnică a proprietății. Prețul pornește de la 2.400 lei/unitate locativă și reprezintă prețul de pornire pentru un apartament sau o unitate locativă standard — poate varia în funcție de tipul, suprafața și complexitatea imobilului. Pentru locuințe mari, case, vile sau proprietăți cu cerințe speciale, costul este stabilit în urma unei evaluări tehnice, printr-o ofertă personalizată."},
        {"h2": "Digital Twin — serviciu PropManage", "body": "Digital Twin este serviciu separat de Audit și reprezintă etapa de modelare digitală completă a proprietății: model 3D detaliat, mapare instalații, integrare planșe tehnice și cartea tehnică digitală vie. Se realizează după finalizarea auditului tehnic, care furnizează datele de intrare. Costul se stabilește în funcție de dimensiunea și complexitatea proiectului și este prezentat într-o ofertă personalizată. Auditul și Digital Twin sunt două servicii distincte, cu roluri diferite: Auditul descoperă, Digital Twin memorează."},
        {"h2": "Statistici de piață — vor fi publicate pe măsură ce colectăm date reale", "body": "Nu publicăm intervale de preț ale pieței și nu facem estimări ale costurilor de implementare — pentru că nu credem în estimări generice. Pe măsură ce PropManage va colecta suficiente date reale din proiecte gestionate în platformă, vom publica statistici și analize relevante privind costurile din România, bazate exclusiv pe date reale și actualizate. Până atunci, orice ofertă pe care o primești pe platformă este personalizată, transparentă și protejată prin escrow."},
        ...
        {"h2": "Designer de interior sau arhitect de interior — pe cine alegi?", "body": "Designerul de interior și arhitectul de interior au roluri complementare și, împreună, oferă cea mai bună soluție. Designerul dezvoltă conceptul, optimizează funcțional spațiul, definește stilul, materialele, mobilierul și poate coordona managementul proiectului, colaborând permanent cu beneficiarul, furnizorii și echipele de execuție. Arhitectul de interior transformă conceptul într-un proiect tehnic complet, coordonează planșele de execuție, instalațiile electrice, sanitare și HVAC, integrează toate specialitățile într-un model BIM și inițiază Digital Twin-ul proprietății. În metodologia PropManage, cele două specializări lucrează împreună, de la concept și proiectare până la implementare, oferind un proces unitar, documentat și eficient."},
