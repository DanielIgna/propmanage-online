...
DEFAULT_CONTENT: dict[str, Any] = {
    ...
    "faq": [
        ...
        {"q": "Cât costă un proiect de design interior?", "a": "Nu există un tarif standard valabil pentru toate proiectele — costul depinde de tipul proiectului, complexitate, suprafață, stil, experiența echipei și serviciile incluse. În cadrul PropManage, Concept Design-ul rezidențial pornește de la aproximativ 2.200 lei/cameră (analiza spațiului, definirea stilului, planuri de mobilier, moodboard-uri, paletă cromatică). Singurul serviciu cu tarif standard afișat este Auditul Digital Twin, de la 2.450 lei pentru o unitate locativă. Proiectele tematice, comerciale sau HoReCa se ofertează exclusiv pe baza unei analize personalizate. Primești oferta exactă gratuit după completarea formularului."},
    ...
    "seo_article": [
        ...
        {"h2": "Cât costă un proiect de design interior în România", "body": "Nu există un tarif standard valabil pentru toate proiectele de design interior din România. Costul este influențat de numeroși factori: tipul proiectului, nivelul de complexitate, suprafața, stilul de amenajare, experiența echipei și serviciile incluse. În practică, specialiștii utilizează mai multe modalități de tarifare: tarif pe metru pătrat, tarif pe oră, tarif pe cameră sau ofertă personalizată pentru întregul proiect. O evaluare corectă poate fi realizată doar după analizarea spațiului și a cerințelor beneficiarului. De la concept până la implementare există numeroase etape care influențează costul final: auditul tehnic, măsurătorile, Digital Twin, proiectarea, alegerea materialelor, documentația tehnică, coordonarea execuției și monitorizarea lucrărilor."},
        {"h2": "Concept Design Rezidențial", "body": "În cadrul serviciilor oferite prin PropManage, Concept Design-ul pentru spații rezidențiale pornește de la aproximativ 2.200 lei/cameră. Acest serviciu este dedicat etapei de concept și poate include analiza spațiului, definirea stilului, planuri de mobilier, moodboard-uri, paletă cromatică și direcția generală de amenajare. Tariful se referă exclusiv la faza de concept și poate varia în funcție de complexitatea proiectului, suprafață și cerințele specifice ale beneficiarului. Pentru proiectele tematice, comerciale, HoReCa sau alte spații speciale, metodologia de lucru și nivelul de complexitate sunt diferite, motiv pentru care prețurile sunt stabilite exclusiv pe baza unei analize personalizate."},
        {"h2": "Audit Digital Twin", "body": "Singurul serviciu cu tarif standard afișat în prezent este Auditul Digital Twin, care începe de la 2.450 lei pentru o unitate locativă. Pe măsură ce PropManage va colecta suficiente date și va realiza analize relevante asupra pieței din România, vor fi publicate și informații statistice privind costurile medii ale serviciilor de design și implementare, bazate pe date reale și actualizate, nu pe estimări generale."},
