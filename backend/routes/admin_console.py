...
# ============= DEFAULTS =============
DEFAULT_CMS = {
    "hero.badge": "Plot 09 · Operating System For Properties",
    "hero.title1": "Casa ta,",
    "hero.title2": "vie",
    "hero.title3": "în 3D.",
    "hero.subtitle": "Digital Twin. Marketplace specialiști. Escrow. Reputație meritocratică. Toate într-un singur ecosistem pentru proprietatea ta.",
    "hero.cta1": "Explorează platforma",
    "hero.cta2": "Vezi journey-ul",
    "cta.title1": "Casa ta merită",
    "cta.title2": "un sistem de operare.",
    "cta.intro": "Înregistrare gratuită. Setup în 3 minute. Primul tău Digital Twin în 48h.",
    "cta.btn1": "Creează cont",
    "cta.btn2": "Am deja cont",
    "footer.copyright": "© 2026 PropManage · Property Operating System",
